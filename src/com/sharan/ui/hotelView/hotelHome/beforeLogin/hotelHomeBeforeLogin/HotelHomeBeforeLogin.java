...
package com.sharan.ui.hotelView.hotelHome.beforeLogin.hotelHomeBeforeLogin;
...
public class HotelHomeBeforeLogin extends JFrame {
    ...
    private void initComponents() {
        ...
        signUp.setFont(new Font("Dialog", Font.BOLD, 22));
        ...
        contentPaneLayout.setHorizontalGroup(
            contentPaneLayout.createParallelGroup()
                .addGroup(contentPaneLayout.createSequentialGroup()
                    ...
                    .addContainerGap())
                .addComponent(homePagePhoto, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 0, Short.MAX_VALUE)
        );
            ...
            contentPaneLayout.createParallelGroup()
                .addGroup(contentPaneLayout.createSequentialGroup()
                    ...
                    .addGroup(contentPaneLayout.createParallelGroup(GroupLayout.Alignment.TRAILING, false)
                        .addComponent(login, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
